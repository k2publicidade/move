...
export interface Bonus { id:string; userId:string; amountCents:number; status:string; type:string; reason?:string; reversalOfId?:string; level?:number; createdAt?:string }
